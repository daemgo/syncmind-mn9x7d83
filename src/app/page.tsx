  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-1/4 left-1/3 w-200 h-150 rounded-full blur-3xl" style={{ background: "radial-gradient(circle, oklch(0.8 0.08 250 / 50%) 0%, transparent 70%)" }} />
        <div className="absolute bottom-0 right-0 w-125 h-100 rounded-full blur-3xl" style={{ background: "radial-gradient(circle, oklch(0.75 0.03 250 / 40%) 0%, transparent 70%)" }} />
        {/* Grid pattern */}
        <div
